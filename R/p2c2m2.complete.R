...
function (path="/home/user/Desktop/", xml.file="beast.xml", 
                           ...
                           error.rate=FALSE, error.reps=1000,
  ...
  #			error.rate = decision if to estimate error rate
  #			error.reps = number of pods to estimate error rate
...
################################
  ...
  assign("P2C2M_flg_errBool", error.rate, envir = P2C2M_globalVars)
  assign("P2C2M_flg_errReps", error.reps, envir = P2C2M_globalVars)
